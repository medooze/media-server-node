...
const Logger		= require("medooze-logger");
...
class Endpoint extends Emitter
{
	 ...
	 * @param {Logger} [logger] Logger to use with unique ID for this transport
	 * @returns {Transport}	New transport object
	 */
	createTransport(remoteInfo, localInfo, options, logger)
	{
