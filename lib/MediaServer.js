...
const SimulcastMediaFrameListenerTrack 		= require("./SimulcastMediaFrameListenerTrack.js");
const IncomingStreamTrack 			= require("./IncomingStreamTrack.js");
...
MediaServer.createSimulcastMediaFrameListenerTrack = function(
	/** @type {string} */ trackId,
	/** @type {string} */ mediaId,
	/** @type {Native.TimeService} */ timeService)
{
	return new IncomingStreamTrackSimulcastAdapter(trackId, mediaId, timeService);
}
