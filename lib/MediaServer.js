...
MediaServer.createIncomingStreamTrackSimulcastAdapter = function(mediaId)
{
	//Create it
	return new IncomingStreamTrackSimulcastAdapter(uuidV4(), mediaId);
}
...
MediaServer.createIncomingStreamSimulcastAdapter = function(streamId, trackId, mediaId)
{
	...
	//Create track
	const incomingStreamTrack =  new IncomingStreamTrackSimulcastAdapter(uuidV4(), mediaId);
	//Add track to stream
