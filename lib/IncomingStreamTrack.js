 ...
 * @property {number} bitrate average media bitrate received during last second in bps
...
function getEncodingStats(/** @type {Encoding} */ encoding)
{
	...
	const encodingStats = {
		...
		totalBitrate	: mediaStats.totalBitrate,
		total		: mediaStats.totalBitrate + rtxStats.totalBitrate,
