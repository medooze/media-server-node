...
{
	const stats = {
		media		: getStatsFromOutgoingSource(source.media),
		rtx		: getStatsFromOutgoingSource(source.rtx),
		remb		: source.media.remb,
		timestamp	: Date.now()
	};
	//Add accumulated bitrate
	stats.rtt		= Math.max(stats.media.rtt,stats.rtx.rtt);
	stats.bitrate		= stats.media.bitrate;
	stats.total		= stats.media.bitrate + stats.rtx.bitrate;
	stats.numFrames		= stats.media.numFrames;
	stats.numFramesDelta	= stats.media.numFramesDelta;
	stats.numPackets	= stats.media.numPackets + stats.rtx.numPackets;
	stats.numPacketsDelta	= stats.media.numPacketsDelta + stats.rtx.numPacketsDelta;
