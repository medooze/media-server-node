...
{
	constructor(transport,track, source)
	{
		//Store track info
		this.id		= track.getId();
		this.media	= track.getMedia();
		this.transport	= transport;
		//If we need to create a new source
		if (!source)
		{
	...
	*/
	...
	attachTo(incomingStreamTrack)
	{
		...
		const transponder  = new native.StreamTransponder(incomingStreamTrack.source,incomingStreamTrack.transport,this.source,this.transport);
	...
	stop()
	{
		...
		this.transport.RemoveOutgoingSourceGroup && this.transport.RemoveOutgoingSourceGroup(this.source);
