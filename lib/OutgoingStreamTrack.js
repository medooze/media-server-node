...
class OutgoingStreamTrack
{
	...
	*/
	 ...
	 * @returns {Transceiver} Track transceiver object
	 */
	attachTo(incomingStreamTrack)
	{
		...
		//Create native transceiver object
		const transceiver  = new native.StreamTransceiver(incomingStreamTrack.source,incomingStreamTrack.transport,this.source,this.transport);
		
		//Store transceiver wrapper
		this.transceiver = new Transceiver(transceiver);
