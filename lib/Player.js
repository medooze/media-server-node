...
class Player extends Emitter
{
	...
	constructor(filename)
	{
		...
		if (this.player.HasVideoTrack())
		{
			...
			//Create new track
			const incomingStreamTrack = new IncomingStreamTrack("video",trackId,null,null,null, {'':SharedPointer(this.player.GetVideoSource())});
		...
		if (this.player.HasAudioTrack())
		{
			...
			//Create new track
			const incomingStreamTrack = new IncomingStreamTrack("audio",trackId,null,null,null, {'':SharedPointer(this.player.GetAudioSource())});
