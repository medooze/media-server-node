...
class StreamerSession
{
	...
	constructor(media,params)
	{
		...
		this.incoming = new IncomingStreamTrack(this.session, new TrackInfo(media.getType(),media.getType()), this.session.GetIncomingSourceGroup());
		this.outgoing = new OutgoingStreamTrack(this.session, new TrackInfo(media.getType(),media.getType()), this.session.GetOutgoingSourceGroup()); 
