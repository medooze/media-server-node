...
class Transport extends Emitter
{
	 ...
	 * @param {CreateStreamTrackOptions | TrackInfoLike | string } params Params plain object or TrackInfo object
	...
	createOutgoingStreamTrack(media, params, outgoingStream)
	{
		...
		if (encodingSource.media)
		{
			...
			source.rtx.ssrc		= encodingSource.rtx;
			source.fec.ssrc		= encodingSource.fec;
		} else  {
			//Generate them
