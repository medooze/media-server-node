...
class Transport
{
	...
	createOutgoingStreamTrack(media, params)
	{
		...
		const source = new Native.RTPOutgoingSourceGroup(type,this.transport.GetTimeService());
		...
		//Create new track
		const outgoingStreamTrack = new OutgoingStreamTrack(media,id,new Native.RTPSenderFacade(this.transport),source);
	...
	createIncomingStreamTrack(media, params)
	{
		...
		//Create new track
		const incomingStreamTrack = new IncomingStreamTrack(media,id,new Native.RTPReceiverFacade(this.transport),sources);
