...
class Transport
{
	...
	createOutgoingStreamTrack(media, params)
	{
		...
		* @type {object}
		*/
		this.emitter.emit("outgoingtrack",outgoingStreamTrack);
	...
	getOutgoingStreams()
	{
		return Array.from(this.ougoingStreams.values());
	}
	...
	createIncomingStreamTrack(media, params)
	{
		...
		*/
		...
		this.emitter.emit("incomingtrack",incomingStreamTrack,incomingStream);
