...
class Transport
{
	...
	constructor(bundle, remote, local, options)
	{
		...
		this.ontargetbitrate = (bitrate, bandwidthEstimation)  => {
			//Store sender side estimator
			this.senderSideTargetBitrate = bitrate;
			...
			* @argument {Transport} transport
			*/
			this.emitter.emit("targetbitrate",bitrate,bandwidthEstimation,this);
		};
	...
	getEstimatedBitrate()
	{
		return this.transport.GetEstimatedBitrate();
	}
