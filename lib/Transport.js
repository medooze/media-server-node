...
class Transport
{
	...
	createOutgoingStream(params) 
	{
		...
		if (params.audio)
		{
			...
			//Generte new ssrc
			let ssrc = params.audio.ssrcs ? params.audio.ssrcs.media : this.lfsr.seq(31);
			//Add to track
			track.addSSRC(ssrc);
			//Add track to stream
			info.addTrack(track);
		...
		if (params.video)
		{
			...
			//Generte new ssrc
			let ssrc = params.video.ssrcs ? params.video.ssrcs.media : this.lfsr.seq(31);
			let rtx  = params.video.ssrcs ? params.video.ssrcs.rtx   : this.lfsr.seq(31);
			let fec  = params.video.ssrcs ? params.video.ssrcs.fec   : this.lfsr.seq(31);
