  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'lib/crypto/math/gf2_8.c',
        'lib/crypto/math/stat.c',
        'lib/crypto/replay/rdb.c',
        'lib/crypto/replay/rdbx.c',
        'lib/crypto/replay/ut_sim.c',
        'lib/crypto/rng/ctr_prng.c',
        'lib/crypto/rng/prng.c',
        'lib/crypto/rng/rand_source.c',
      ],
      'conditions': [
        ['use_openssl==1', {
          'sources!': [
          ...
          'sources': [
            ...
            'lib/crypto/rng/rand_source_ossl.c',
          ],
        }],
      ],
    }, # target libsrtp
